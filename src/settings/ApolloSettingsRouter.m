...
static void ApolloSettingsRouterEnsureRegistry(void) {
    ...
    dispatch_once(&onceToken, ^{
        ...
        add(@"subreddit-sections", @"Subreddit List", @"Apollo Reborn → Features → Subreddits", ^UIViewController *{
        ...
        add(@"automatic-backups", @"Backup Settings", @"Apollo Reborn → Data", ApolloSettingsInsetGrouped([ApolloAutomaticBackupViewController class]));
